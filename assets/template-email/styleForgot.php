  ...
  <center style="width:100%;table-layout:fixed;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;background-color:#e1e5e8;">
    <div style="max-width:600px;margin-top:0;margin-bottom:0;margin-right:auto;margin-left:auto;">
      <table align="center" cellpadding="0" style="border-spacing:0;font-family:'Muli',Arial,sans-serif;color:#333333;Margin:0 auto;width:100%;max-width:600px;">
        <tbody>
          <tr>
            <td align="center" class="vervelogoplaceholder" height="143" style="padding-top:0;padding-bottom:15px;padding-right:0;padding-left:0;height:143px;vertical-align:middle;" valign="middle"><a href="#" target="_blank"><img alt="Bazar André" src="<?php echo $_POST['baseUrl']; ?>assets/images/logo-bazar.png" style="border-width: 0px; width: 160px; " width="160"></a></span></td>
          </tr>
          <!-- Start of Email Body-->
          <tr>
                ...
                <tbody>
                  ...
                  <tr>
                    <td class="inner contents center" style="padding-top:15px;padding-bottom:15px;padding-right:30px;padding-left:30px;text-align:left;">
                      <center>
                        <p class="h1 center" style="Margin:0;text-align:center;font-family:'flama-condensed','Arial Narrow',Arial;font-weight:100;font-size:30px;Margin-bottom:26px;">Perdeu sua senha?</p>
                        <!--[if (gte mso 9)|(IE)]><![endif]-->

                        <p class="description center" style="font-family:'Muli','Arial Narrow',Arial;Margin:0;text-align:center;max-width:320px;color:#a1a8ad;line-height:24px;font-size:14pt;Margin-bottom:10px;margin-left: auto; margin-right: auto;"><span style="color: rgb(161, 168, 173); font-family: Muli, &quot;Arial Narrow&quot;, Arial; font-size: 14pt; text-align: center; background-color: rgb(255, 255, 255);">Tudo bem, acontece! Clique no botão abaixo para redefinir sua senha.</span></p><br>
                        
                        <a class="buttonRedf" href="<?php echo $_POST['url']; ?>" target="_blank">Redefinir senha</a>
                  ...
                  <tr>
                    <td>
                      <p style="text-align:center; padding: 10px ; font-family:'Muli','Arial Narrow',Arial;">Caso você não tenha solicitado a redefinição de senha desconsidere este e-mail,<br>
          ...
          <tr>
            <td style="padding-top:0;padding-bottom:0;padding-right:30px;padding-left:30px;text-align:center;Margin-right:auto;Margin-left:auto;">
              <center>
                ...
                <p style="font-family:'Muli',Arial,sans-serif;Margin:0;text-align:center;Margin-right:auto;Margin-left:auto;font-size:15px;color:black;line-height:23px;">ou envie um e-mail <a href="mailto:biadigy@hotmail.com" style="color:black;text-decoration:underline;" target="_blank">biadigy@hotmail.com</a></p>

                <p style="font-family:'Muli',Arial,sans-serif;Margin:0;text-align:center;Margin-right:auto;Margin-left:auto;padding-top:10px;padding-bottom:0px;font-size:15px;color:#a1a8ad;line-height:23px;">© 2020 Fragrância e Wine<span style="white-space: nowrap"><!-- --></span>. <span style="white-space: nowrap"><!--  --></span> <span style="white-space: nowrap">  <!--  -->  </span></p>
              </center>
            </td>
          </tr>
          <!-- whitespace -->
